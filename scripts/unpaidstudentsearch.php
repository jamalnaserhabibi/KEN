...
<html lang="en">
<head>
    <link rel="stylesheet" href="../css/unpaidstudentsearch.css">
...
<div class="maincontaner">
    <center>
        ...
        <form method="get" action="unpaidstudent_list.php" enctype="multipart/form-data">
            <div class="inputs">

                <h3>Student Root ID</h3>
                ...
                <select class="ttt" name="cyear">
                    ...
                    try {
                        $query = "select  distinct YEAR(ccreatedate) from tblclass order by ccreatedate desc ";
                ...
                <select class="ttt" name="classname">
                    <?php
                    require_once("connection.php");
